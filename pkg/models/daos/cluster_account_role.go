...
// ClusterAccountRole 用户在集群的角色
type ClusterAccountRole struct {
	//主键
...
func (md *ClusterAccountRole) TableName() string {
	return models.ClusterAccountRoleTableName
}
func (md *ClusterAccountRole) Indexes() (results map[string][]string) {
	results = make(map[string][]string)
	results["idx_cluster_id"] = []string{"cluster_id"}
	results["idx_account_id"] = []string{"account_id"}
	results["idx_creator_id"] = []string{"creator_id"}
	return
}
func (md *ClusterAccountRole) UniqueIndexes() (results map[string][]string) {
	results = make(map[string][]string)
