...
type ClusterAccountDetail struct {
	...
	//客户端证书
	ClientCertificate string `gorm:"type:text;column:client_certificate" json:"-" description:"客户端证书"`
	//客户端Key
	ClientKey string `gorm:"type:text;column:client_key" json:"-" description:"客户端Key"`
	//CSR名称:用户在集群中CSR名称
	CsrName string `gorm:"type:varchar(200);column:csr_name" json:"csrName" validate:"required" description:"CSR名称"`
	//集群核准状态
...
type ClusterAccountUpdate struct {
	...
	ClientKey string `gorm:"type:text;column:client_key" json:"clientKey" description:"客户端Key"`
	//CSR名称:用户在集群中CSR名称
	CsrName string `gorm:"type:varchar(200);column:csr_name" json:"csrName" description:"CSR名称"`
	//集群核准状态
