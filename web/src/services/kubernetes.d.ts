...
// Value 实现 driver.Valuer 接口，Value 返回 json value
export type ApplicationRenderParams = Record<string, any>;
// ApplicationRenderResult 应用模版资源渲染结果
...
// Value 实现 driver.Valuer 接口，Value 返回 json value
export type GpuResourceParamDefinitions = GpuResourceParamDefinition[];
// Value 实现 driver.Valuer 接口，Value 返回 json value
...
// Value 实现 driver.Valuer 接口，Value 返回 json value
export type GroupVersionResources = GroupVersionResource[];
// Value 实现 driver.Valuer 接口，Value 返回 json value
...
export type ImageRegistryAuth = { 
  auths?: Record<string, ImageRegistryAuthLine>;
}; 
// PodResourceResize pod资源调整
...
export type ResourceIndex = Record<string, number>;
