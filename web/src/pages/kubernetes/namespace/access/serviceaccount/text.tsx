...
const YamOrJsonForm: FC<Record<string, any>> = () => {
  ...
  const BaseAddress = namespace
    ? toKubernetesQueryRoute(`/kubernetes/cluster/${cluster}/namespace/${namespace}/access/serviceaccounts`)
    : toKubernetesQueryRoute(`/kubernetes/cluster/${cluster}/access/serviceaccounts`);
