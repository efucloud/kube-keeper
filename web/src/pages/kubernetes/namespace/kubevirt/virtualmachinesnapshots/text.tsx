...
const TextPage: React.FC = () => {
  ...
  const updateApi = buildKubeVirtCollectionApi(resourceGroup.groupVersion, 'virtualmachinesnapshots', resolvedNamespace);
  const createApi = buildKubeVirtCollectionApi(resourceGroup.groupVersion, 'virtualmachinesnapshots', namespace || 'default');
      ...
      <Card>
        {!create && info?.apiVersion ? (
          <ResourceJsonOrYamlForm
            ...
            key="VirtualMachineSnapshot-update"
        ...
        {create ? (
          <ResourceJsonOrYamlForm
            ...
            key="VirtualMachineSnapshot-create"
            kind="VirtualMachineSnapshot"
            scope="namespace"
            create={true}
