...
const TextPage: React.FC = () => {
  ...
  const updateApi = buildKubeVirtCollectionApi(resourceGroup.groupVersion, 'virtualmachineinstances', resolvedNamespace);
  const createApi = buildKubeVirtCollectionApi(resourceGroup.groupVersion, 'virtualmachineinstances', namespace || 'default');
      ...
      <Card>
        {!create && info?.apiVersion ? (
          <ResourceJsonOrYamlForm
            ...
            key="VirtualMachineInstance-update"
        ...
        {create ? (
          <ResourceJsonOrYamlForm
            ...
            key="VirtualMachineInstance-create"
            kind="VirtualMachineInstance"
            scope="namespace"
            create={true}
