...
const TextPage: React.FC = () => {
  ...
  const updateApi = buildKubeVirtCollectionApi(resourceGroup.groupVersion, 'virtualmachinerestores', resolvedNamespace);
  const createApi = buildKubeVirtCollectionApi(resourceGroup.groupVersion, 'virtualmachinerestores', namespace || 'default');
      ...
      <Card>
        {!create && info?.apiVersion ? (
          <ResourceJsonOrYamlForm
            ...
            key="VirtualMachineRestore-update"
        ...
        {create ? (
          <ResourceJsonOrYamlForm
            ...
            key="VirtualMachineRestore-create"
            kind="VirtualMachineRestore"
            scope="namespace"
            create={true}
