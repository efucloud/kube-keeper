...
const YamOrJsonForm: FC<Record<string, any>> = () => {
  ...
  const BaseAddress = namespace ? toKubernetesQueryRoute(`/kubernetes/cluster/${cluster}/namespace/${namespace}/config/configmaps`) : toKubernetesQueryRoute(`/kubernetes/cluster/${cluster}/config/configmaps`)
