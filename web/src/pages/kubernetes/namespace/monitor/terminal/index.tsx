...
import { Button, Empty, message, Popover, Select, Space, Tag, theme, Typography } from 'antd';
        ...
        return (
          <>
            <a
              onClick={() => {
                window.open(
                  toKubernetesQueryRoute(`/kubernetes/cluster/${cluster}/namespace/${entity?.metadata?.namespace}/monitor/terminal`),
                );
              }}
            >
