...
const YamOrJsonForm: FC<Record<string, any>> = () => {
  ...
  const BaseAddress = namespace ? toKubernetesQueryRoute(`/kubernetes/cluster/${cluster}/namespace/${namespace}/devops/cicd/tekton/taskruns`) : toKubernetesQueryRoute(`/kubernetes/cluster/${cluster}/devops/cicd/tekton/taskruns`);
