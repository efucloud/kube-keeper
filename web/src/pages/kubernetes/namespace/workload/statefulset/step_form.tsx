...
const AdvancedStepForm: FC<Record<string, any>> = () => {
  ...
  let BaseAddress = `/kubernetes/cluster/${cluster}/namespace/${selectedNamespace}/workload/statefulsets`;
          ...
          {success && <Result
            ...
            extra={
              <Fragment>
                <Button type="primary"
                  onClick={() => {
                    window.location.href = `/kubernetes/cluster/${cluster}/namespace/${info.metadata?.namespace}/workload/statefulsets/${info.metadata?.name}`
                  }}
