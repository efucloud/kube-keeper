...
const TextPage: React.FC = () => {
  ...
  let baseAddress = toKubernetesQueryRoute(`/kubernetes/cluster/${cluster}/namespace/${namespace}/faas/fission/httptrigger`);
  if (namespace === '' || namespace === '-') {
    baseAddress = toKubernetesQueryRoute(`/kubernetes/cluster/${cluster}/faas/fission/httptrigger`);
  }
