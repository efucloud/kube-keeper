    ...
    >
      <Card>
        <Descriptions column={2}>
          ...
          <Descriptions.Item label={intl.formatMessage({ id: 'cluster.resource.kind' })}>{formatResourceKind(intl, info?.kind || 'VirtualMachineClusterInstancetype')}</Descriptions.Item>
