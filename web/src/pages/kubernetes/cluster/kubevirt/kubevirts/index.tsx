...
const IndexPage: React.FC = () => {
  ...
  const baseApi = buildKubeVirtCollectionApi(resourceGroup.groupVersion, 'kubevirts');
          ...
          <Popconfirm
            ...
            onConfirm={async () => {
              await clusterDeleteProxy({
                cluster,
                address: `${buildKubeVirtCollectionApi(resourceGroup.groupVersion, 'kubevirts', record.metadata?.namespace || '')}/${record.metadata?.name || ''}`,
              });
