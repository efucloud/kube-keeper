...
const schema81 = {
  ...
  properties: {
    ...
    kind: {
      $ref: '07Mm1HBt08u0qzfZy2W3ShVsG0vilft7gOmqKK0Dg',
    },
    metadata: {
  ...
  $id: 'trainer.kubeflow.org.v1alpha1.ClusterTrainingRuntime',
};
const schema82 = {
  type: 'string',
...
function validate280(
  ...
  if (!(data === 'ClusterTrainingRuntime')) {
    const err1 = {
      instancePath,
      schemaPath: '#/enum',
      keyword: 'enum',
...
function validate277(
  ...
  /*# sourceURL="trainer.kubeflow.org.v1alpha1.ClusterTrainingRuntime" */
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
