...
import { validate } from '../../_schemas/TrainerKubeflowOrgV1alpha1ClusterTrainingRuntime';
 ...
 */
export interface IClusterTrainingRuntime {
  /**
    ...
    template: {
      ...
      spec?: {
        ...
        failurePolicy?: {
           ...
           */
          restartStrategy?: 'Recreate' | 'BlockingRecreate';
          /**
          ...
          rules?: Array<{
             ...
             */
            onJobFailureReasons?: Array<string>;
            /**
             ...
             */
            targetReplicatedJobs?: Array<string>;
          }>;
        };
        /**
        ...
        startupPolicy?: {
           ...
           */
          startupPolicyOrder: 'AnyOrder' | 'InOrder';
        };
        /**
 ...
 * by TrainJob that created in \*any\* namespace.
 */
export class ClusterTrainingRuntime
  extends Model<IClusterTrainingRuntime>
  implements IClusterTrainingRuntime
{
  apiVersion: IClusterTrainingRuntime['apiVersion'];
  kind: IClusterTrainingRuntime['kind'];
  metadata?: IClusterTrainingRuntime['metadata'];
  spec?: IClusterTrainingRuntime['spec'];

  static apiVersion: IClusterTrainingRuntime['apiVersion'] =
    'trainer.kubeflow.org/v1alpha1';
  static kind: IClusterTrainingRuntime['kind'] = 'ClusterTrainingRuntime';
  static is = createTypeMetaGuard<IClusterTrainingRuntime>(
    ClusterTrainingRuntime,
  );

  constructor(data?: ModelData<IClusterTrainingRuntime>) {
    super();

    this.setDefinedProps({
      apiVersion: ClusterTrainingRuntime.apiVersion,
      kind: ClusterTrainingRuntime.kind,
      ...data,
    } as IClusterTrainingRuntime);
  }
}

setValidateFunc(
  ClusterTrainingRuntime,
  validate as ValidateFunc<IClusterTrainingRuntime>,
);
