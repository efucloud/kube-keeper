...
import { validate } from '../../_schemas/TrainerKubeflowOrgV1alpha1TrainingRuntime';
 ...
 */
export interface ITrainingRuntime {
  /**
...
export class TrainingRuntime
  extends Model<ITrainingRuntime>
  implements ITrainingRuntime
{
  apiVersion: ITrainingRuntime['apiVersion'];
  kind: ITrainingRuntime['kind'];
  metadata?: ITrainingRuntime['metadata'];
  spec?: ITrainingRuntime['spec'];

  static apiVersion: ITrainingRuntime['apiVersion'] =
    'trainer.kubeflow.org/v1alpha1';
  static kind: ITrainingRuntime['kind'] = 'TrainingRuntime';
  static is = createTypeMetaGuard<ITrainingRuntime>(TrainingRuntime);

  constructor(data?: ModelData<ITrainingRuntime>) {
    super();

    this.setDefinedProps({
      apiVersion: TrainingRuntime.apiVersion,
      kind: TrainingRuntime.kind,
      ...data,
    } as ITrainingRuntime);
  }
}

setValidateFunc(TrainingRuntime, validate as ValidateFunc<ITrainingRuntime>);
