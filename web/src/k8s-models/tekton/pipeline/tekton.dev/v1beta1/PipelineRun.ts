...
import { validate } from '../../_schemas/TektonDevV1beta1PipelineRun';
 ...
 * Deprecated: Please use v1.PipelineRun instead.
 */
export class PipelineRun extends Model<IPipelineRun> implements IPipelineRun {
  apiVersion: IPipelineRun['apiVersion'];
  kind: IPipelineRun['kind'];
  metadata?: IPipelineRun['metadata'];
  spec?: IPipelineRun['spec'];
  status?: IPipelineRun['status'];

  static apiVersion: IPipelineRun['apiVersion'] = 'tekton.dev/v1beta1';
  static kind: IPipelineRun['kind'] = 'PipelineRun';
  static is = createTypeMetaGuard<IPipelineRun>(PipelineRun);

  constructor(data?: ModelData<IPipelineRun>) {
    super();
...
setValidateFunc(PipelineRun, validate as ValidateFunc<IPipelineRun>);
