...
const schema6 = {
  ...
  properties: {
    ...
    kind: {
      $ref: 'r1CsSF4H4t7gaVdh1FjVFGmOnAhcFX6jbFgqg2Pwkqw',
    },
    metadata: {
  ...
  $id: 'triggers.tekton.dev.v1alpha1.TriggerTemplate',
};
const schema7 = {
  type: 'string',
...
function validate21(
  ...
  /*# sourceURL="triggers.tekton.dev.v1alpha1.TriggerTemplate" */
  let vErrors = null;
  let errors = 0;
