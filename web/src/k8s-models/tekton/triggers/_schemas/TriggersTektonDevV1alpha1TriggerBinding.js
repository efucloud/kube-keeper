...
const schema6 = {
  ...
  properties: {
    ...
    kind: {
      $ref: 'aTjhZRBA4iBY56HMitefvMkrjvpzRT7xal3PPM7Y',
    },
    metadata: {
  ...
  $id: 'triggers.tekton.dev.v1alpha1.TriggerBinding',
};
const schema7 = {
  type: 'string',
...
function validate21(
  ...
  /*# sourceURL="triggers.tekton.dev.v1alpha1.TriggerBinding" */
  let vErrors = null;
  let errors = 0;
