...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "n8AJ9P4opayN23OIgKw7mV6aDLiTUPhPwFtntPq80s"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "swzadSJhgFtfORmjQWThJnJtbXkVxuSBCtNnoMz5w"
    },
    "status": {
  ...
  "$id": "gateway.networking.x-k8s.io.v1alpha1.XBackendTrafficPolicy"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    "retryConstraint": {
      "$ref": "KTNgnPoDU84lFdiUKh2JrvcZccdfuADvWbmCsDmlW9I"
    },
    "sessionPersistence": {
      "$ref": "ZFahNjsNWgpz7Xsj4WQ601zJ3PI9rsWDMi97K10NI"
    },
    "targetRefs": {
      "$ref": "rmKR9moTsp24RMQrzRs4yas3Gy7bFr87RYSQ"
    }
  },
  "required": ["targetRefs"],
  "type": "object"
...
const schema14 = {
  "properties": {
    "budget": {
      "$ref": "td1zuAfYH0Tmw4UkYcDmR2oWlCsJAR7oECI74zoFo"
    },
    "minRetryRate": {
      "$ref": "tf8BEqnXG4zREmjRhUYJ6dB8r0zaBovmjAQQCdcXU"
    }
  },
  "type": "object",
  "nullable": true
...
const schema15 = {
  ...
  "properties": {
    "interval": {
      "$ref": "K4dWSrt3bjitdqsP3U82yFGK6HURycendc8sP1qvZA"
    },
    "percent": {
      "$ref": "gehzdR21AbLG9NKE0PObSM35cPwH4gAkJUr0DxIM"
    }
  },
  "type": "object",
  "nullable": true
...
const schema18 = {
  ...
  "properties": {
    "count": {
      "$ref": "9JPJhhLI7RSPgfXN3FwzDpBlz3kTQknNijMTyKPQA"
    },
    "interval": {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.minRetryRate !== undefined) {
      if (!validate40(data.minRetryRate, {
        instancePath: instancePath + "/minRetryRate",
        parentData: data,
        parentDataProperty: "minRetryRate",
        rootData
      })) {
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.lifetimeType !== undefined) {
      if (!validate49(data.lifetimeType, {
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.absoluteTimeout !== undefined) {
      if (!validate21(data.absoluteTimeout, {
    ...
    if (data.cookieConfig !== undefined) {
      if (!validate48(data.cookieConfig, {
    ...
    if (data.sessionName !== undefined) {
      if (!validate53(data.sessionName, {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.retryConstraint !== undefined) {
      if (!validate33(data.retryConstraint, {
        instancePath: instancePath + "/retryConstraint",
        parentData: data,
        parentDataProperty: "retryConstraint",
        rootData
      })) {
    ...
    if (data.sessionPersistence !== undefined) {
      if (!validate46(data.sessionPersistence, {
...
function validate71(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sectionName !== undefined) {
      if (!validate81(data.sectionName, {
...
const pattern8 = new RegExp("^[A-Za-z]([A-Za-z0-9_,:]*[A-Za-z0-9_])?$", "u");
...
const pattern9 = new RegExp("^([a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*/)?(([A-Za-z0-9][-A-Za-z0-9_.]*)?[A-Za-z0-9])$", "u");
...
function validate85(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate86(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate90(data.observedGeneration, {
...
const pattern10 = new RegExp("^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*\\/[A-Za-z0-9\\/\\-._~%!$&'()*+,;=:]+$", "u");
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.ancestorRef !== undefined) {
      if (!validate71(data.ancestorRef, {
    ...
    if (data.controllerName !== undefined) {
      if (!validate100(data.controllerName, {
...
function validate23(data, {
  ...
  /*# sourceURL="gateway.networking.x-k8s.io.v1alpha1.XBackendTrafficPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
