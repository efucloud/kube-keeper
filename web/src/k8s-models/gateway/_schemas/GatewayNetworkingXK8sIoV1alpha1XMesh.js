...
const schema6 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "YW3EA8CpRWG0kFRg8zo7cLWzcCxPYtEs5YNKXyIKPQ"
    },
    "kind": {
      "$ref": "mEg8gXxuOLk1x2Yeot5Tx54dVZ4YOIb4uAUSFFFzV0"
    },
    "metadata": {
    ...
    "status": {
      "$ref": "fqBtB39LjWU7OTWQTbgfbGFJs65Kzb5TUIKk3Q0Kn0"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "gateway.networking.x-k8s.io.v1alpha1.XMesh"
};
const schema7 = {
  "type": "string",
  "enum": ["gateway.networking.x-k8s.io/v1alpha1"]
};
function validate22(data, {
  ...
  if (!(data === "gateway.networking.x-k8s.io/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate21(data, {
  ...
  /*# sourceURL="gateway.networking.x-k8s.io.v1alpha1.XMesh" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
