...
const schema21 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "1WGghQpD9vQudtgWo1n4kl6dJWu6mezbA9KpToRuU"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "0KbFuOh1mnekmFLxox4lW5Go5e4YtTNxC9cwOUc"
    },
    "status": {
      "$ref": "KK71alboV7cnOHm6HjahelU21zYKCvbp28WLhuMuyoA"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "gateway.networking.k8s.io.v1.ListenerSet"
};
const schema22 = {
  "type": "string",
...
const schema25 = {};
import { validate as validate51 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema26 = {
  "properties": {
    ...
    "parentRef": {
      "$ref": "cPKJ348FxFmqMgeUIUMBMFV3cH2Be35JoPc0qQcers"
    }
  },
  "required": ["listeners", "parentRef"],
  "type": "object"
};
const schema27 = {
  "items": {
...
const pattern5 = new RegExp("^[a-zA-Z]([-a-zA-Z0-9]*[a-zA-Z0-9])?$", "u");
...
function validate62(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate63(data.matchExpressions, {
    ...
    if (data.matchLabels !== undefined) {
      if (!validate72(data.matchLabels, {
...
const pattern6 = new RegExp("^(\\*\\.)?[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*$", "u");
...
const pattern7 = new RegExp("^[a-zA-Z0-9]([-a-zA-Z0-9]*[a-zA-Z0-9])?$|[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*\\/[A-Za-z0-9]+$", "u");
...
function validate85(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificateRefs !== undefined) {
      if (!validate86(data.certificateRefs, {
...
function validate56(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowedRoutes !== undefined) {
      if (!validate57(data.allowedRoutes, {
...
function validate118(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.attachedRoutes !== undefined) {
      if (!validate119(data.attachedRoutes, {
    ...
    if (data.conditions !== undefined) {
      if (!validate121(data.conditions, {
    ...
    if (data.supportedKinds !== undefined) {
      if (!validate39(data.supportedKinds, {
...
function validate113(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate114(data.conditions, {
        instancePath: instancePath + "/conditions",
        parentData: data,
        parentDataProperty: "conditions",
        rootData
...
function validate45(data, {
  ...
  /*# sourceURL="gateway.networking.k8s.io.v1.ListenerSet" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
