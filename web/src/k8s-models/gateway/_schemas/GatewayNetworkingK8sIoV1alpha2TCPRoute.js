...
const schema13 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "GjarYqPeCKjoVa9gayKCQdw3jfaRIgBWVcGNKu8zdaI"
    },
    "kind": {
      "$ref": "i2yUWkVAdGp55n4E1kjdxU9AVba0isy6vzpnxiQzes"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "dmq686tuBSfMcR2KgoO3edxw78RwSxluaNPXoNT6W0"
    },
    "status": {
  ...
  "$id": "gateway.networking.k8s.io.v1alpha2.TCPRoute"
};
const schema14 = {
  "type": "string",
  "enum": ["gateway.networking.k8s.io/v1alpha2"]
};
function validate35(data, {
  ...
  if (!(data === "gateway.networking.k8s.io/v1alpha2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema18 = {
  "properties": {
    ...
    "rules": {
      "$ref": "P0NXL9T15Lagg39quIHtJ91E9vrAckloTNGz3sduk"
    },
    "useDefaultGateways": {
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.backendRefs !== undefined) {
      if (!validate49(data.backendRefs, {
...
function validate43(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.useDefaultGateways !== undefined) {
      if (!validate65(data.useDefaultGateways, {
...
const pattern8 = new RegExp("^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*\\/[A-Za-z0-9\\/\\-._~%!$&'()*+,;=:]+$", "u");
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.controllerName !== undefined) {
      if (!validate87(data.controllerName, {
...
function validate34(data, {
  ...
  /*# sourceURL="gateway.networking.k8s.io.v1alpha2.TCPRoute" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
