...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "OK6sCP9GWT9MDkG5GHEGx02p34Dvo5uzC7DVyybE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "0zHNajl2Z4ZfIMLEMB0FdcjxXf7623H3vzKtyG8JQ"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "gateway.networking.k8s.io.v1beta1.ReferenceGrant"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    "from": {
      "$ref": "XtVf0CeyRGgS5pXqCF4sLBYPSX1zYSYdEA55IcU1Co"
    },
    "to": {
      "$ref": "l0uyRpb7s3mJGaSZye3i4n2Y365o5gxVLqPkIXWKGc"
    }
  },
  "required": ["from", "to"],
  "type": "object",
...
const schema14 = {
  "items": {
    "$ref": "tQbJH3DuAjPXykBJ5DVJPGRkOZu1OSNbFkJQpK2M"
  },
  "maxItems": 16,
  "minItems": 1,
  "type": "array"
...
const schema17 = {
  "items": {
    "$ref": "Xo8tdcbEn8Dn4XjZwkqShUGdBltjGRylpLz9lJnJs"
  },
  "maxItems": 16,
  "minItems": 1,
  "type": "array"
...
function validate23(data, {
  ...
  /*# sourceURL="gateway.networking.k8s.io.v1beta1.ReferenceGrant" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
