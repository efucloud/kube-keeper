...
export const validate = validate92;
const schema45 = {
  "type": "object",
  "properties": {
    "apiVersion": {
      "$ref": "UHpdka32gQUMGsBqG7V0P4YoxvGc3HR8PcuPKfZlU"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "bmqb9zckJDc8LyerCgFPn6TIpwqbNcak8VZKeHmSrqg"
    },
    "status": {
      "$ref": "xdYLUkGI1h9GpgtomwMFL8t4OaAn86nos0sj0lZJNo"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "gateway.networking.k8s.io.v1beta1.Gateway"
};
const schema46 = {
  "type": "string",
  "enum": ["gateway.networking.k8s.io/v1beta1"]
};
function validate93(data, {
  ...
  if (!(data === "gateway.networking.k8s.io/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema49 = {};
import { validate as validate98 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema50 = {
  "properties": {
    "addresses": {
      "$ref": "tBXpZYHnA2bwORln7PWHNpGC0w4uGIsri028RPZODsw"
    },
    "allowedListeners": {
      "$ref": "iwOVhEh0stI1cQzJLK50qJkNruybk46NKpY0OMd8oM"
    },
    "defaultScope": {
    ...
    "infrastructure": {
      "$ref": "eqBeM09LVzY8W2iobWzJjbl1Sn6955I3WJ2rc8Wu3X0"
    },
    "listeners": {
      "$ref": "gdCLaR2CEfHjFw5LfyCSHZftSqOVBH931U1YliS1c"
    },
    "tls": {
      "$ref": "hwGKHjB561Pu70JrbZS6eGfJnazVoAPW1JMH7AvJO24"
    }
  },
...
const schema51 = {
  "items": {
    "$ref": "ENz2HwIvYPCGGFumc8cGMFD215ttMubtbvc6O52g8"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
const schema52 = {
  "oneOf": [{
    "$ref": "czeV3WNkkgqzWFODM63bCo3QSpSTTiX1SDzZFQ2DbJ8"
  }, {
    "$ref": "YwtWLpDDmEmOCWZcvstzQ0d1e1Gscl45XjHguMWI"
  }],
  "properties": {
    "type": {
      "$ref": "xKKvTAVxCNFRfOASKHh0dvJb2tJ37vQXCopds85zY"
    },
    "value": {
...
const schema28 = {
  "properties": {
    "type": {
      "$ref": "poPlSbT0u1HSZ9gLwAkubYDCukt2mCo3zXvuhWFYQ"
    },
    "value": {
      "$ref": "myvG0IYNz6nDvd24EGlS6fExIaY59rfrR5IOC00uE"
    }
  }
};
const schema6 = {
...
const schema29 = {
  "anyOf": [{
    "$ref": "rTfYNi7E9sUcSCrAmZDBz0hAnEL0NySNMjz9wB30cE"
  }, {
    "$ref": "wvCWtePkJd8vV7ki8rV1ycz04ujlopnF4bQEDIVjCg"
  }]
};
const schema30 = {
  "format": "ipv4"
};
const formats2 = /^(?:(?:25[0-5]|2[0-4]\d|[01]?\d\d?)\.){3}(?:25[0-5]|2[0-4]\d|[01]?\d\d?)$/;
...
const formats4 = /^((([0-9a-f]{1,4}:){7}([0-9a-f]{1,4}|:))|(([0-9a-f]{1,4}:){6}(:[0-9a-f]{1,4}|((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:))|(([0-9a-f]{1,4}:){5}(((:[0-9a-f]{1,4}){1,2})|:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:))|(([0-9a-f]{1,4}:){4}(((:[0-9a-f]{1,4}){1,3})|((:[0-9a-f]{1,4})?:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9a-f]{1,4}:){3}(((:[0-9a-f]{1,4}){1,4})|((:[0-9a-f]{1,4}){0,2}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9a-f]{1,4}:){2}(((:[0-9a-f]{1,4}){1,5})|((:[0-9a-f]{1,4}){0,3}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9a-f]{1,4}:){1}(((:[0-9a-f]{1,4}){1,6})|((:[0-9a-f]{1,4}){0,4}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(:(((:[0-9a-f]{1,4}){1,7})|((:[0-9a-f]{1,4}){0,5}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:)))$/i;
...
const schema32 = {
  "properties": {
    "type": {
      "$ref": "7tUuUWxgbxVdN1WeYT9H6tBC9O25CVCqSlAeP7bLY"
    }
  }
};
const schema33 = {
...
const pattern5 = new RegExp("^Hostname|IPAddress|NamedAddress|[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*\\/[A-Za-z0-9\\/\\-._~%!$&'()*+,;=:]+$", "u");
...
const schema54 = {
  "properties": {
    "namespaces": {
      "$ref": "Ia23VGtl7c2u6hgJ2zcIc4HYdFRR9D3XyUyCot595r0"
    }
  },
  "type": "object",
  "nullable": true
...
const schema55 = {
  ...
  "properties": {
    "from": {
      "$ref": "Un9KruX1SVXxZLk4hQmyDBhrDM6YffdlC0U8Mj5Vj4"
    },
    "selector": {
...
function validate113(data, {
  ...
  if (!(data === "All" || data === "Selector" || data === "Same" || data === "None")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate111(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.namespaces !== undefined) {
      if (!validate112(data.namespaces, {
...
const schema58 = {
  "properties": {
    "annotations": {
      "$ref": "Q3qCfXBiSQnqFPotX6tKpl7AzyF6p4VxMrhulRuGfN0"
    },
    "labels": {
      "$ref": "T2bR89A5A8Wtt37xjF6iyZl0spTjmPtMfz6C3StwuA"
    },
    "parametersRef": {
...
const schema15 = {
  "additionalProperties": {
    "$ref": "tyVEs7dYSKRRTN5W9WWUiOVANwKZejjekF6RCn9udqI"
  },
  "maxProperties": 16,
  "type": "object",
  "properties": {},
...
const schema59 = {
  "additionalProperties": {
    "$ref": "Aeb4sgFaNTUmGXDH5dfBsj233H1Yzoj8fJDh1n44RsE"
  },
  "maxProperties": 8,
  "type": "object",
  "properties": {},
...
const pattern10 = new RegExp("^(([A-Za-z0-9][-A-Za-z0-9_.]*)?[A-Za-z0-9])?$", "u");
...
const pattern0 = new RegExp("^[a-zA-Z]([-a-zA-Z0-9]*[a-zA-Z0-9])?$", "u");
...
function validate121(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.annotations !== undefined) {
      if (!validate38(data.annotations, {
    ...
    if (data.parametersRef !== undefined) {
      if (!validate127(data.parametersRef, {
        instancePath: instancePath + "/parametersRef",
        parentData: data,
        parentDataProperty: "parametersRef",
        rootData
      })) {
...
const schema62 = {
  "items": {
    "$ref": "rdsSgCJweIOpoIrDpG8p7JHgsFs9UmUthRelVXVFTXY"
  },
  "maxItems": 64,
  "minItems": 1,
  "type": "array"
...
const schema63 = {
  "properties": {
    "allowedRoutes": {
      "$ref": "3LFTWyKQrgQ0b2psQbafGjo4w346dL3ikQpwvsA"
    },
    "hostname": {
      "$ref": "7MTXiYxU79hB7VpKGmxfLwAJL0WS8hIEyCOHihyy9g"
    },
    "name": {
      "$ref": "AndTNze2NbAt7FHti8aNffAUO57QPrMPGFxsWLCEs"
    },
    "port": {
      "$ref": "M3e4CI1pxMbT7irEv6Oc4EcgNJAWQoBFKzamDfws8"
    },
    "protocol": {
      "$ref": "6g5Fn3Ur6HNK1LYSaQfqUBDx5pfjWIutkQfXDrLH5E"
    },
    "tls": {
      "$ref": "8dpAea6Tv2qW9OwkfyX92tJHvwfRn15zDmEHy4d2Y"
    }
  },
...
const schema64 = {
  ...
  "properties": {
    "kinds": {
      "$ref": "Wg4vnqHmLHTBdAkMnewXciRxLCQNkfaMe1Yz4SA"
    },
    "namespaces": {
...
const schema42 = {
  "items": {
    "$ref": "8HNAm4rn2Klw0kMDRUfgkKAZJVREr2AApay7W8T1aA"
  },
  "maxItems": 8,
  "type": "array",
  "nullable": true
...
function validate135(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaces !== undefined) {
      if (!validate137(data.namespaces, {
        instancePath: instancePath + "/namespaces",
        parentData: data,
        parentDataProperty: "namespaces",
        rootData
...
const pattern8 = new RegExp("^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*$", "u");
...
const pattern12 = new RegExp("^[a-zA-Z0-9]([-a-zA-Z0-9]*[a-zA-Z0-9])?$|[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*\\/[A-Za-z0-9]+$", "u");
...
const schema69 = {
  "properties": {
    "certificateRefs": {
      "$ref": "I45XxEzrLIRSc9QdICuhhWEibxhdauOSQqL8AiBkA"
    },
    "mode": {
      "$ref": "ZjwrfXfrjaC6ixkBJNXJj8cK4S7fP9W0RSYfY0K8Uc"
    },
    "options": {
      "$ref": "Q3qCfXBiSQnqFPotX6tKpl7AzyF6p4VxMrhulRuGfN0"
    }
...
const schema70 = {
  "items": {
    "$ref": "HyHJ0e5dC0TTLd3j7Jyh4A5XrVZ8JGOPGcQlZTYWM"
  },
  "maxItems": 64,
  "type": "array",
  "nullable": true
...
const schema71 = {
  "properties": {
    ...
    "kind": {
      "$ref": "oRYYndLldnfGNK0hsbRflN1M5INp0nbrLJ2wciQZZ1Q"
    },
    "name": {
      "$ref": "xwpijLRhjUEJllEse3cgJuQz6UsEYqfhm0t12sQjFe4"
    },
...
function validate158(data, {
  ...
  if (!(data === "Terminate" || data === "Passthrough")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate149(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.certificateRefs !== undefined) {
      if (!validate150(data.certificateRefs, {
        instancePath: instancePath + "/certificateRefs",
        parentData: data,
        parentDataProperty: "certificateRefs",
        rootData
      })) {
...
function validate134(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.allowedRoutes !== undefined) {
      if (!validate135(data.allowedRoutes, {
        instancePath: instancePath + "/allowedRoutes",
        parentData: data,
        parentDataProperty: "allowedRoutes",
        rootData
      })) {
...
const schema73 = {
  "properties": {
    "backend": {
      "$ref": "KEQsISyDWXT3YqHr9sPhs9TsenAB0wU8IchZEvg9Os"
    },
    "frontend": {
      "$ref": "ODgPSQvRYtYwUmZQerDJykj2y1zurA7ZxWCqfZX4sA"
    }
  },
  "type": "object",
  "nullable": true
...
const schema74 = {
  "properties": {
    "clientCertificateRef": {
      "$ref": "cSCJhOb6TraxGG9vPAgzHD5Qt62KJSYlJNuMUEj47IY"
    }
  },
  "type": "object",
  "nullable": true
...
function validate165(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.clientCertificateRef !== undefined) {
      if (!validate166(data.clientCertificateRef, {
        instancePath: instancePath + "/clientCertificateRef",
        parentData: data,
        parentDataProperty: "clientCertificateRef",
        rootData
      })) {
...
const schema76 = {
  "properties": {
    "default": {
      "$ref": "h53DsTg801p1xbib4WunbpWbAolQpvNIfZKzr9M"
    },
    "perPort": {
      "$ref": "njZCHQs4w720SWkytIFpIvZnE6QVkKeNrJCBCYm0"
    }
  },
  "required": ["default"],
  "type": "object",
...
const schema22 = {
  "properties": {
    "validation": {
      "$ref": "Z9TZxkiFsfMVuR4mX90wLZjUWjILk2kQpvix5lZzRs"
    }
  },
  "type": "object"
};
const schema23 = {
  "properties": {
    "caCertificateRefs": {
      "$ref": "jBZYaQ8iiutbxWCd9K2NryAFpyqeJcrtwHvsUVJU"
    },
    "mode": {
      "$ref": "JbOIXfhPq9M636jhmETJGtreBqmCEJZtJeumqlkXr8"
    }
  },
...
function validate56(data, {
  ...
  if (!(data === "AllowValidOnly" || data === "AllowInsecureFallback")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.caCertificateRefs === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "caCertificateRefs"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.caCertificateRefs !== undefined) {
      if (!validate48(data.caCertificateRefs, {
        instancePath: instancePath + "/caCertificateRefs",
        parentData: data,
        parentDataProperty: "caCertificateRefs",
        rootData
      })) {
...
const schema77 = {
  "items": {
    "$ref": "83fYpVpps5SLXsiweCHihByXnym84WgvGKWECReefM"
  },
  "maxItems": 64,
  "type": "array",
  "nullable": true
...
function validate173(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.perPort !== undefined) {
      if (!validate175(data.perPort, {
        instancePath: instancePath + "/perPort",
        parentData: data,
        parentDataProperty: "perPort",
        rootData
      })) {
...
function validate101(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.gatewayClassName === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "gatewayClassName"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.allowedListeners !== undefined) {
      if (!validate111(data.allowedListeners, {
        instancePath: instancePath + "/allowedListeners",
        parentData: data,
        parentDataProperty: "allowedListeners",
        rootData
      })) {
    ...
    if (data.defaultScope !== undefined) {
      if (!validate118(data.defaultScope, {
        instancePath: instancePath + "/defaultScope",
        parentData: data,
        parentDataProperty: "defaultScope",
        rootData
      })) {
    ...
    if (data.gatewayClassName !== undefined) {
      if (!validate23(data.gatewayClassName, {
        instancePath: instancePath + "/gatewayClassName",
        parentData: data,
        parentDataProperty: "gatewayClassName",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
    ...
    if (data.infrastructure !== undefined) {
      if (!validate121(data.infrastructure, {
        instancePath: instancePath + "/infrastructure",
        parentData: data,
        parentDataProperty: "infrastructure",
        rootData
      })) {
    ...
    if (data.listeners !== undefined) {
      if (!validate133(data.listeners, {
        instancePath: instancePath + "/listeners",
        parentData: data,
        parentDataProperty: "listeners",
        rootData
      })) {
...
const schema79 = {
  ...
  "properties": {
    "addresses": {
      "$ref": "YOG4AjGEXp3PuayvpLBwYZwnclgcViq09U46QCbvBJk"
    },
    "attachedListenerSets": {
      "$ref": "Ccz0XZyNWiwVpe2nvsmnlMV1SnfQGMXuejl0yByE"
    },
    "conditions": {
      "$ref": "EKcaZ2w4JeV8WNybYUPdNxWXggZLSuMn8l07QJJjqKE"
    },
    "listeners": {
      "$ref": "H6kqkJEXCqurwj6kTmgUbC9lMrE6WEgiekLZHofaOU"
    }
  },
  "type": "object",
  "nullable": true
...
const schema80 = {
  "items": {
    "$ref": "RXumGCHjEr95OThQaZjqOGJpnfD9rHKTbwAC7UzI4LQ"
  },
  "maxItems": 16,
  "type": "array",
  "nullable": true
...
function validate72(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate77(data.observedGeneration, {
...
const schema84 = {
  "items": {
    "$ref": "eWGKhFCuP8iunt67hIz5aupRaMuyg0eO1Y9FJe80"
  },
  "maxItems": 64,
  "type": "array",
  "nullable": true
...
const schema85 = {
  "properties": {
    ...
    "conditions": {
      "$ref": "UZOby9togoLNNhHu7HMZOwTjEP7GSa7FCWEJ1Y68Y"
    },
    "name": {
      "$ref": "AndTNze2NbAt7FHti8aNffAUO57QPrMPGFxsWLCEs"
    },
  ...
  "required": ["attachedRoutes", "conditions", "name"],
  "type": "object"
};
const schema86 = {
  "format": "int32",
...
function validate199(data, {
  ...
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.attachedRoutes === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "attachedRoutes"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
    ...
    if (data.attachedRoutes !== undefined) {
      if (!validate200(data.attachedRoutes, {
        instancePath: instancePath + "/attachedRoutes",
        parentData: data,
        parentDataProperty: "attachedRoutes",
        rootData
      })) {
    ...
    if (data.conditions !== undefined) {
      if (!validate202(data.conditions, {
    ...
    if (data.supportedKinds !== undefined) {
      if (!validate86(data.supportedKinds, {
        instancePath: instancePath + "/supportedKinds",
        parentData: data,
        parentDataProperty: "supportedKinds",
        rootData
      })) {
        vErrors = vErrors === null ? validate86.errors : vErrors.concat(validate86.errors);
        errors = vErrors.length;
...
function validate184(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.attachedListenerSets !== undefined) {
      if (!validate193(data.attachedListenerSets, {
        instancePath: instancePath + "/attachedListenerSets",
        parentData: data,
        parentDataProperty: "attachedListenerSets",
        rootData
      })) {
    ...
    if (data.conditions !== undefined) {
      if (!validate195(data.conditions, {
        instancePath: instancePath + "/conditions",
        parentData: data,
        parentDataProperty: "conditions",
        rootData
...
function validate92(data, {
  ...
  /*# sourceURL="gateway.networking.k8s.io.v1beta1.Gateway" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
