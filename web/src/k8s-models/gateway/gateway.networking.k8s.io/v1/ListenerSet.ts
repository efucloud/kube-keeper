...
import { validate } from "../../_schemas/GatewayNetworkingK8sIoV1ListenerSet";
 ...
 *   - The ListenerSet's status has the condition "Accepted: true"
 */
export class ListenerSet extends Model<IListenerSet> implements IListenerSet {
  "apiVersion": IListenerSet["apiVersion"];
  "kind": IListenerSet["kind"];
  "metadata"?: IListenerSet["metadata"];
  "spec": IListenerSet["spec"];
  "status"?: IListenerSet["status"];

static apiVersion: IListenerSet["apiVersion"] = "gateway.networking.k8s.io/v1";
static kind: IListenerSet["kind"] = "ListenerSet";
static is = createTypeMetaGuard<IListenerSet>(ListenerSet);

constructor(data?: ModelData<IListenerSet>) {
  super();

  this.setDefinedProps({
    apiVersion: ListenerSet.apiVersion,
    kind: ListenerSet.kind,
    ...data
  } as IListenerSet);
}
}
...
setValidateFunc(ListenerSet, validate as ValidateFunc<IListenerSet>);
