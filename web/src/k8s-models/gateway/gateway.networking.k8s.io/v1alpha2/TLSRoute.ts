...
import { validate } from "../../_schemas/GatewayNetworkingK8sIoV1alpha2TLSRoute";
 ...
 * in matching streams for a given TLS listener.
 */
export class TLSRoute extends Model<ITLSRoute> implements ITLSRoute {
  "apiVersion": ITLSRoute["apiVersion"];
  "kind": ITLSRoute["kind"];
  "metadata"?: ITLSRoute["metadata"];
  "spec": ITLSRoute["spec"];
  "status"?: ITLSRoute["status"];

static apiVersion: ITLSRoute["apiVersion"] = "gateway.networking.k8s.io/v1alpha2";
static kind: ITLSRoute["kind"] = "TLSRoute";
static is = createTypeMetaGuard<ITLSRoute>(TLSRoute);

constructor(data?: ModelData<ITLSRoute>) {
  super();

  this.setDefinedProps({
    apiVersion: TLSRoute.apiVersion,
    kind: TLSRoute.kind,
    ...data
  } as ITLSRoute);
}
...
setValidateFunc(TLSRoute, validate as ValidateFunc<ITLSRoute>);
