...
import { validate } from "../../_schemas/GatewayNetworkingK8sIoV1beta1ReferenceGrant";
...
static apiVersion: IReferenceGrant["apiVersion"] = "gateway.networking.k8s.io/v1beta1";
