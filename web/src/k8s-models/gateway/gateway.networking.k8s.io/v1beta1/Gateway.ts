...
import { validate } from "../../_schemas/GatewayNetworkingK8sIoV1beta1Gateway";
...
static apiVersion: IGateway["apiVersion"] = "gateway.networking.k8s.io/v1beta1";
