...
import { validate } from "../../_schemas/GatewayNetworkingK8sIoV1alpha3BackendTLSPolicy";
...
static apiVersion: IBackendTLSPolicy["apiVersion"] = "gateway.networking.k8s.io/v1alpha3";
